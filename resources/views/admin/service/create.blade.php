        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">เพิ่มการให้บริการ</h3>
                ...
                <div class="box-body">
                    ...
                    <form id="form-insert-service" method="post">
                        @csrf
                        <div class="form-group mb-3">
                            <label class="col-form-label">ชื่อ</label>
                            <input class="form-control" name="service_name" type="text" required
                                   placeholder="">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" rows="10" name="service_description"></textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" rows="20" name="service_mission"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" rows="20"
                                              name="service_learning_activity"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" name="service_contact_phone_number" type="text" required
                                           placeholder="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" name="service_contact_name" type="text" required
                                           placeholder="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" name="service_address" type="text" required
                                   placeholder="">
                        </div>

                        <div class="form-group mb-3">
                            <label class="col-form-label">ฝังแผนที่ตำแหน่งที่ตั้ง</label>
                            <textarea class="form-control" rows="5" name="service_embed_map"></textarea>
                        </div>
...
@section('admin_script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#form-insert-service').formValidation({
                framework: 'bootstrap',
                fields: {
                    service_name: {
                        validators: {
                ...
                .on('success.form.fv', function (event) {
                    ...
                    $(".loading").show();
                    $.ajax({
                        url: '{{url("administrator/service/store")}}',
                        method: 'POST',
                        data: $("#form-insert-service").serialize(),
