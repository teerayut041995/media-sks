        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="form-insert-banner" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mb-3">
                                <img src="{{url('images/banner/example.jpg')}}" class="profile-img" id="imagePreview">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">ลิงค์ 1</label> <small class="text-muted">
                                        *เว้นว่างได้</small>
                                    <input class="form-control" name="banner_first_link" type="text"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Text to display</label> <small class="text-muted">
                                        *เว้นว่างได้</small>
                                    <input class="form-control" name="banner_first_link_text"
                                           type="text"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">ลิงค์ 2</label> <small class="text-muted">
                                        *เว้นว่างได้</small>
                                    <input class="form-control" name="banner_second_link" type="text"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Text to display</label> <small class="text-muted">
                                        *เว้นว่างได้</small>
                                    <input class="form-control" name="banner_second_link_text" type="text"
                                           placeholder="WEBSITE">
                                </div>
                            </div>
                        </div>
...
@section('admin_script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#form-insert-banner').formValidation({
                framework: 'bootstrap',
                fields: {
                    banner_name: {
                        validators: {
                    ...
                    banner_file_name: {
                        validators: {
                            notEmpty: {
                                message: 'กรุณากรอกอัพโหลดไฟล์รูปภาพแบนเนอร์'
                            },
                            file: {
                ...
                .on('success.form.fv', function (event) {
                    ...
                    $.ajax({
                        url: '{{url("administrator/banner/store")}}',
                        method: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
