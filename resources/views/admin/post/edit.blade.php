                ...
                <div class="box-body">
                    <form action="{{action('PostController@update' , $id)}}" method="POST"
                        ...
                        <div class="form-group col-lg-6 col-md-6">
                            ...
                            <textarea class="form-control" rows="4" name="post_detail"
                                      required>{{$post->post_detail}}</textarea>
                        ...
                        <div class="form-group col-lg-6 col-md-6">
                            <label>Embed Youtube Video <small>( *เว้นว่างได้ )</small></label>
                            <textarea name="post_youtube_embed" class="form-control"
                                      rows="4">{{$post->post_youtube_embed}}</textarea>
                        </div>

                        <div class="form-group col-lg-12 col-md-12">
                            <label>Youtube Link <small>( *เว้นว่างได้ )</small></label>
                            <input class="form-control" name="post_youtube_link" value="{{$post->post_youtube_link}}">
                        </div>
                        ...
                        <div class="form-group col-lg-12 col-md-12">
                            ...
                            <textarea name="summernoteInput" id="summernoteInput"
                                      class="summernote">{!!$post->post_content!!}</textarea>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function defaultCategory() {
                ...
                let sub_category_id = `{{$post->sub_category_id}}`;
                $.ajax({
