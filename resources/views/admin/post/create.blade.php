                ...
                <div class="box-body">
                    <form action="{{url('administrator/post')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-lg-6 col-md-6">
                            ...
                            <textarea class="form-control" name="post_detail" rows="4" required></textarea>
                        ...
                        <div class="form-group col-lg-6 col-md-6">
                            ...
                            <textarea name="post_youtube_embed" class="form-control" rows="4"></textarea>
                        </div>

                        <div class="form-group col-lg-12 col-md-12">
                            <label>Youtube Link <small>( *เว้นว่างได้ )</small></label>
                            <input class="form-control" name="post_youtube_link">
                        </div>
