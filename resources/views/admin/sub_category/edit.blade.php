...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				<form action="{{action('SubCategoryController@update' , $id)}}" method="POST">
					{{ csrf_field() }}
					{{method_field('PATCH')}}
					...
					<div class="form-group col-lg-7 col-md-7">
	                  ...
	                  <input type="text" class="form-control" id="sub_category_name" name="sub_category_name" value="{{$sub_category->sub_category_name}}">
	                ...
	                <div class="form-group col-lg-7 col-md-7">
	                  ...
	                  <input type="number" class="form-control" id="sub_category_ranking" name="sub_category_ranking" value="{{$sub_category->sub_category_ranking}}" style="width: 20%;">
