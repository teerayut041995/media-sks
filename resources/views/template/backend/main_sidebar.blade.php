...
<!-- Sidebar user panel (optional) -->
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            <a href="#"><i class="fa fa-link"></i> <span>การให้บริการ</span>
                <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="{{url('administrator/service')}}">การให้บริการทั้งหมด</a></li>
                <li><a href="{{url('administrator/service/create')}}">เพิ่มการให้บริการ</a></li>
            </ul>
        </li>
        <li class="treeview">
