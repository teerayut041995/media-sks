    ...
    <section class="blog_details-area pt-60 pb-80">
        <div class="container">
            <div class="blog_details-img">
                <img src='{{url("images/image_post/$post->post_image")}}' alt="{{$post->post_title}}" style="border-radius: 25px;">
            </div>
            <div class="row">
                        ...
                        <div class="blog_details-top mb-50">
                            ...
                            <div class="blog_details-meta">
                                ...
                                <div class="blog_details-category">
                                    ...
                                    <h5>{{formatDateThaiBirthday($post->created_at)}}, {{Carbon\Carbon::parse($post->created_at)->diffForHumans()}}</h5>
                                </div>
                                <div class="blog_details-category">
                                ...
                                <div class="col-md-6">
                                    <div class="h2_blog-item mb-30">
                                        <div class="h2_blog-img">
                                            <a href='{{url("article/$related->post_slug")}}'><img src='{{url("images/image_post/$related->post_image")}}'
                                        ...
                                        <div class="h2_blog-content">
                                            ...
                                            <h5 class="h2_blog-content-title"><a href='{{url("article/$related->post_slug")}}'>{{$related->post_title}}</a></h5>
                                            <a href='{{url("article/$related->post_slug")}}' class="theme-btn blog-btn t-theme-btn">เพิ่มเติม</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
