...
<meta name="description" content="อ่านบทความเกี่ยวกับการศึกษาพิเศษ การพัฒนานักเรียนพิเศษ ในหมวดหมู่ {{$category->category_name}} ได้ที่เว็บไซต์ {{config('app.name')}}">
		...
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="{{asset('')}}">หน้าหลัก </a>  
					<span class="lnr lnr-arrow-right"></span><a href="javascript:void(0)">{{$category->category_name}} </a>
				</p>
			</div>	
		</div>
	</div>
					...
					<div class="single-popular-carusel col-lg-4 col-md-6">
							<div class="thumb-wrap relative">
								...
								<div class="meta d-flex justify-content-between">
									...
									<P>การดู {{ $post->views_count }} ครัง</p>
								</div>								
							</div>
							<div class="details">
								<a href="<?php echo url("article/$post->post_slug"); ?>">
									<h4 class="my-font">
										{{$post->post_title}}
									</h4>
								</a>
